        ...
        <>
          <Table hoverable className="shadow-md bg-[#f5e6c1]">
            <Table.Head className="bg-[#c7a57a]">
              <Table.HeadCell className="bg-[#c7a57a] text-[#4b3621]">Date created</Table.HeadCell>
              ...
              <Table.HeadCell className="bg-[#c7a57a] text-[#4b3621]">Email</Table.HeadCell>
              <Table.HeadCell className="bg-[#c7a57a] text-[#4b3621]">Admin</Table.HeadCell>
            ...
            {users.map((user) => (
              <Table.Body className='divide-y' key={user._id}>
                <Table.Row className="bg-[#f5e6c1] dark:border-[#7d6245] dark:bg-[#e6c8a5]">
                  ...
                  <Table.Cell className="text-[#4b3621]">{user.email}</Table.Cell>
                  <Table.Cell>
                    {user.isAdmin ? (
