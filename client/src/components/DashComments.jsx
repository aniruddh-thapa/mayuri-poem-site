  ...
  return (
    <div className='w-full table-auto overflow-x-scroll md:mx-auto p-3 scrollbar scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500'>
      {currentUser.isAdmin && comments.length > 0 ? (
        <>
          <Table className="shadow-md bg-[#f5e6c1]">
            <Table.Head className="bg-[#c7a57a]">
              ...
              <Table.HeadCell className="bg-[#c7a57a] text-[#4b3621]">Number of likes</Table.HeadCell>
              <Table.HeadCell className="bg-[#c7a57a] text-[#4b3621]">PostId</Table.HeadCell>
              <Table.HeadCell className="bg-[#c7a57a] text-[#4b3621]">UserId</Table.HeadCell>
